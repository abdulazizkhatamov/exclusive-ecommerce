...
import { getChatAccounts } from "@/api/api-chat.ts";
import { columns } from "@/features/chat/accounts/columns.tsx";
import { DataTableToolbar } from "@/features/chat/accounts/data-table-toolbar.tsx";

const ChatAccountsPage: React.FC = () => {
...
export default ChatAccountsPage;
