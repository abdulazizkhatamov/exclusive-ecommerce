...
import { Overview } from "@/components/custom/category/overview.tsx";
import { RecentSales } from "@/components/custom/category/recent-sales.tsx";
...
const SubcategoryPage: React.FC = () => {
  ...
  //   queryKey: ["subcategories", _id],
  //   queryFn: () => getSubcategoriesByCategoryId(_id as string),
  // });
  ...
  return (
    <>
      ...
      <CreateSubcategorySheet categoryId={_id as string} />
      <UpdateSubcategorySheet categoryId={_id as string} />
      <DeleteSubcategoryDialog categoryId={_id as string} />
    </>
  );
};
